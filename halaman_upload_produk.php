...
<head>
    ...
    <link rel="stylesheet" href="..\styles\halaman-upload-produks.css">
...
<header>
  ...
  <content>
    ...
    <div class="first">
      ...
      <div class="tag-name">
      <label for="tag-text"><b>Nama Produk</b></label>
      <input type="text" placeholder="Nama Produk...." name="name-shop" id="name-shop" required>
      </div>
      </div>

      <div class="content-second">
      <div class="tag-name">
      <label for="tag-text"><b>Deskripsi Produk</b></label>
      <textarea type=long-text placeholder="Deskripsi Produk...." name="name-shop" id="name-shop" required></textarea>
      </div>
      </div>
    </div>
    ...
    <div class="content-first">
    <div class="tag-name">
      <label for="tag-text"><b>Tambah Foto</b></label>
...
<?php 
  if(isset($_POST['proses'])){
    ...
    echo '</script>';
    echo '<script>window.location.href = "../model/pembelian.php";</script>';
  }
?>